...
} from './characters.js?v=8';
import { playSnip, playStitch, playWrong, playSuccess, playClick, playStar, playSave } from './audio.js?v=8';
import { loadGallery, saveEntry, deleteEntry } from './storage.js?v=8';
import * as stage3d from './stage3d.js?v=8';
